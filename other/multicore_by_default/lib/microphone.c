// NOTE: UNTESTED on native platforms, missing implementation

// #include "microphone.h"
// #include "../os.h"
// #include "fmt.h"
//
// extern u32 _os_mic_get_available_samples(void);
// extern u32 _os_mic_read_samples(i16 *buffer, u32 max_samples);
// extern void _os_mic_start_recording(void);
// extern void _os_mic_stop_recording(void);
// extern u32 _os_mic_get_sample_rate(void);
//
// MicrophoneState microphone_init(AppContext *ctx) {
//   MicrophoneState state = {0};
//
//   state.sample_rate = _os_mic_get_sample_rate();
...
//   }
//
//   return _os_mic_get_available_samples();
// }
//
...
//   }
//
//   u32 samples_read = _os_mic_read_samples(buffer, max_samples);
//
//   return samples_read;
// }
//
