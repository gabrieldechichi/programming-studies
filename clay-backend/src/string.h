...
// strlen - optimized by clang to use word-at-a-time scanning
...
#define i32_to_str(value, str) __error("i32_to_str not implemented for platform")
#define f32_to_str(value, str, precision) __error("f32_to_str not implemented for platform")
#endif
